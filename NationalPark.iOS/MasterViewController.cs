	...
	public partial class MasterViewController : UITableViewController
	{
		...
		public override void PrepareForSegue(UIStoryboardSegue segue, NSObject sender)
		{
			if (segue.Identifier == "showDetail")
			{
                ...
                controller.SetNavData(dataSource.Parks, item);
			}
            else if(segue.Identifier == "editFromMaster")
            {
                var controller = (EditViewController)((UINavigationController)segue.DestinationViewController).TopViewController;
                controller.SetNavData(dataSource.Parks, new NationalPark());
            }
		}
		...
		class DataSource : UITableViewSource
		{
			...
			public DataSource(MasterViewController controller)
			{
                ...
                string serializedParks = File.ReadAllText(Path.Combine(dataFolder, "NationalParks.json"));
                parks = JsonConvert.DeserializeObject<List<NationalPark>>(serializedParks);

            }

            public IList<NationalPark> Parks
            {
				get { return parks; }
			}
			...
			public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
			{
                ...
                cell.TextLabel.Text = parks[indexPath.Row].ToString();
